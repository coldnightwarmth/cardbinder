...
assert(page.includes("../app.js?v=cardnft-474"), "Poncho page has a stale app cache key");
assert(page.includes("../styles.css?v=cardnft-170"), "Poncho page has a stale style cache key");
