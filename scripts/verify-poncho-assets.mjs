...
assert(page.includes("../app.js?v=cardnft-397"), "Poncho page has a stale app cache key");
assert(page.includes("../styles.css?v=cardnft-167"), "Poncho page has a stale style cache key");
